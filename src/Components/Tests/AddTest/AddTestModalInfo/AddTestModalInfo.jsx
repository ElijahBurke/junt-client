...
function AddTestModalInfo({ setShowAddTest }) {
  ...
  return (
    <div className="AddTestModalInfo">
      <form onSubmit={onSubmit} autoComplete="off">
        ...
        <label>
          Enter At Least 30 Characters Describing what aspects of your application
...
AddTestModalInfo.propTypes = {
  setShowAddTest: PropTypes.func.isRequired,
};

export default AddTestModalInfo;
