...
function AddingAppForm({ cover, idFromTest, setAddingApplication }) {
  ...
  const onSubmit = (e) => {
    ...
    buildAppObjectAndStore(toUpdateCover)
      .then(R.compose(
        (action) => setUpdatedCoverLetter(action.payload.application.cover),
        dispatch,
        actionCreators.addApplication,
      ));
  };
  ...
  return (
    <div className="AddingAppForm__modal">
      {!updatedCoverLetter
        ? (
